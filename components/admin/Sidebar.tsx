...
import { LayoutDashboard, FolderKanban, Wrench, LogOut, Globe } from "lucide-react";
...
export default function AdminSidebar() {
  ...
  return (
    <aside className="fixed left-0 top-0 bottom-0 w-64 bg-[#111827] border-r border-gray-800 flex flex-col z-50">
      {/* Logo */}
